-- ============================================================
--  ROSWEL — CORRECTIF DESIGN N°2 : carte de résultats enrichie
-- ============================================================
--  À exécuter comme les précédents :
--  Supabase → SQL Editor → New query → tout coller → Run
--  (Remplace le correctif précédent — sans danger s'il a déjà
--   été exécuté.)
--
--  La recherche renvoie maintenant AUSSI le nombre de
--  publications Instagram (affiché sur les nouvelles cartes).
-- ============================================================
