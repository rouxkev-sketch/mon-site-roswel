...
const { entreesDuFiltre, TOUS_LES_STYLES } = await import(
  pathToFileURL(RACINE + "/src/lib/filtres-selection.ts").href
);
const { suivisDuStyle, comptesParStyleDesSuivis, comptesParStyleDesJaime } =
...
const entreesJaime = entreesDuFiltre(comptesParStyleDesJaime(photosAimees));
