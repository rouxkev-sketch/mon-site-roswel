...
export async function generateMetadata({
   ...
   * carrousel, la route `/artist/<slug>/share`, qui rend LA MÊME
  ...
  const imageDuCarrousel = tagsPartage.toString()
    ? {
        images: [
          {
            url:
              `${adresseDuSite()}/artist/${tatoueur.slug}/share` +
  ...
  return {
    ...
    alternates: privee
      ? undefined
      : { canonical: `${adresseDuSite()}/artist/${tatoueur.slug}` },
...
export default async function PageFicheTatoueur({
  ...
  if (!tatoueur) {
    ...
    if (actuel && actuel !== slug) {
      permanentRedirect(
        style ? `/artist/${actuel}?style=${style}` : `/artist/${actuel}`
      );
    }
  }
    ...
    <>
      ...
      <JsonLd
        donnees={{
          ...
          url: `${adresseDuSite()}/artist/${tatoueur.slug}`,
          mainEntity: {
            "@type":
        ...
        donnees={{
          ...
          itemListElement: [
              ...
              : []),
            {
              ...
              name: tatoueur.nom,
              item: `${adresseDuSite()}/artist/${tatoueur.slug}`,
            },
          ],
        }}
      />
