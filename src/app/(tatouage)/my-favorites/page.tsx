...
export const metadata: Metadata = {
  ...
  //  de la page. L'ADRESSE, elle, ne change pas : /my-favorites reste
  //  /my-favorites, pour ne casser aucun lien déjà partagé ni aucune
