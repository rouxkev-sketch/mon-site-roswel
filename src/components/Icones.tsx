...
/*  ⛔ LES DEUX PERSONNAGES « SUIVRE » / « SUIVI » (nº 869-§3) NE SONT
    PLUS ICI : une tête, des épaules, et un plus ou une coche à droite.
    Le propriétaire a tranché à la nº 871-§6 — le badge « Follow » porte
    LE SIGNE SEUL, et ces signes existaient déjà (`IconePlus`,
    `IconeCocheListe`). Deux dessins sans lecteur sont un piège pour la
    passe suivante : ils partent (règle nº 386). */
